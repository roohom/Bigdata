 ...
 */
public class SecondHouseCountPartition extends Configured implements Tool {

    @Override
    public int run(String[] args) throws Exception {
        Job job = Job.getInstance(this.getConf(), "userCount");
        job.setJarByClass(SecondHouseCountPartition.class);
        ...
        Path outputPath = new Path("datas\\HouseOutput\\CustomizePartition");
    ...
    public static void main(String[] args) throws Exception {
        ...
        int status = ToolRunner.run(conf, new SecondHouseCountPartition(), args);
        System.exit(status);
    }
